...
public class CabinetBlockEntity extends RandomizableContainerBlockEntity {
    ...
    public CabinetBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(FBlockEntityTypes.CABINET.get(), blockPos, blockState);
        this.items = NonNullList.withSize(27, ItemStack.EMPTY);
        this.openersCounter = new ContainerOpenersCounter() {
            protected void onOpen(Level level, BlockPos pos, BlockState state) {
                CabinetBlockEntity.this.playSound(SoundEvents.BARREL_OPEN);
                CabinetBlockEntity.this.updateBlockState(state, true);
            }

            protected void onClose(Level level, BlockPos pos, BlockState state) {
                CabinetBlockEntity.this.playSound(SoundEvents.BARREL_CLOSE);
    ...
    protected Component getDefaultName() {
        return Component.translatable("container.furnies.cabinet");
    }
